...
<div class="cabecalho">
     ...
     ?>       
        ...
        <div class="nome_foto">
            ...
            <?php
                  ...
                  if ($imagem=="" || $imagem=="img/perfilsemfoto.png")
                  {
                      echo("<img class=\"fotoperfil\" src='img/perfilsemfoto.png' width=\"100px\">");
   
                  }
                  else{
                  echo("<img class=\"fotoperfil\" src='data:image/jpeg;base64,$imagem' width=\"100px\">");
       ...
       ?>   
            ...
            <div class="nomeconta"><?php echo( $texto); ?></div>
        </div>
        <div class="titulos">
    ...
    $comando = $pdo->prepare("SELECT * FROM `jogadores` LIMIT 3;");
    $resultado = $comando->execute();  
    ...
    ?>
     <button class="Ver_todos">
            <a href="dash2.php"><span class="Ver Todos">Ver todos</span></a>
        </button>  
</div>
